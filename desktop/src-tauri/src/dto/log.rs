//! Debug-log view DTOs: execution tree, hotspots, statements, limit rollups,
//! the offline step-debugger outline, and the log-list / fetched-log wrappers.
//! Holds the mappers from the serde-unaware `log_parser` / `features` models.
